...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://kaphomechios.com'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Book directly. No Airbnb fees. 48 m² apartment in Chios Town centre, beach under 1 km.',
...
export const viewport: Viewport = { themeColor: '#0F2137' }
...
const jsonLd = {
  ...
  numberOfRooms: 1,
  aggregateRating: { '@type': 'AggregateRating', ratingValue: 4.97, reviewCount: 28, bestRating: 5, worstRating: 1 },
  amenityFeature: PROPERTY.amenities.map(a => ({ '@type': 'LocationFeatureSpecification', name: a.label, value: true })),
}
